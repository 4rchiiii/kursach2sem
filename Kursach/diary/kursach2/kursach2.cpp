...
int main() {
    SetConsoleOutputCP(1251); // Устанавливает кодировку консоли для вывода на русском языке
    SetConsoleCP(1251); // Устанавливает кодировку консоли для ввода на русском языке
    setlocale(LC_ALL, "Russian"); // Устанавливает локаль для корректного отображения русских символов
